...
class GameBoardScreen2 extends StatefulWidget {
  const GameBoardScreen2({super.key});

  @override
  State<GameBoardScreen2> createState() => _GameBoardScreenState();
}

class _GameBoardScreenState extends State<GameBoardScreen2> {
  late CardDeck _deck;
